...
parser.add_argument('--save-dir', type=str, default='splits', help="path to save output json file (default: 'splits/')")
parser.add_argument('--save-name', type=str, default='fvs_splits', help="name to save as, excluding extension (default: 'fvs_splits')")
...
def create():
    ...
    # keys = ["video_" + i for i in os.listdir('yt_vids')]
    keys = ["video_" + str(i) for i in range(1,35)]
    num_videos = len(keys)
