...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--regularization_factor', type=float, default=5.0) # 0.15
...
# PATH_TVSum = '../H5_file/fvs.h5' ### change to gn_full.h5 for oh dataset
...
# DATASET_PATH= '../H5_file/fvs.h5' ### change to gn_full.h5 for oh dataset
