...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--weight-decay', type=float, default=1e-5) # 1e-5
    parser.add_argument('--lambda-reg', type=float, default=5.0) # 1.0
    parser.add_argument('--nms-thresh', type=float, default=0.5) # 0.5
    ...
    # anchor based
    parser.add_argument('--neg-sample-ratio', type=float, default=2.0) # 2.0
    parser.add_argument('--incomplete-sample-ratio', type=float, default=1.0) # 1.0
    parser.add_argument('--pos-iou-thresh', type=float, default=0.6) # 0.6
    parser.add_argument('--neg-iou-thresh', type=float, default=0.0) # 0.0
    parser.add_argument('--incomplete-iou-thresh', type=float, default=0.3) # 0.3
