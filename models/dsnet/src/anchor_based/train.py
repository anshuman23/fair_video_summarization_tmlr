...
def train(args, split, save_path):
    ...
    for epoch in range(args.max_epoch):
        ...
        for _, seq, gtscore, cps, n_frames, nfps, picks, _, vid_name in train_loader:
            ...
            print(f'  vid: {vid_name}, loss_cls: {stats.cls_loss}, loss_loc: {stats.loc_loss}, loss: {stats.loss}')
